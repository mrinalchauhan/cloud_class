...
aws iam attach-role-policy --policy-arn "arn:aws:iam::aws:policy/test-policy" --role-name test-role
...
#attach test-role to all users in user group testing
aws iam attach-group-policy --policy-arn "arn:aws:iam::aws:policy/test-policy" --group-name testing
